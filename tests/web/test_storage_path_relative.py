...
class TestRelativePathStorage:
    ...
    def test_to_relative_path_converts_absolute_to_relative(self, test_db, monkeypatch):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            monkeypatch.setattr("xagent.web.utils.file.UPLOADS_DIR", uploads_dir)
            monkeypatch.setattr(
                "xagent.web.models.uploaded_file.UPLOADS_DIR", uploads_dir
            )
    ...
    def test_uploaded_file_absolute_path_property_relative_storage(
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Relative path is without user_{user_id} prefix
